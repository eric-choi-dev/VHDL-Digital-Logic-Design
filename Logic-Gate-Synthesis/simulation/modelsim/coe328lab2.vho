...
-- x4	=>  Location: PIN_B12,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- x3	=>  Location: PIN_C12,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default


ARCHITECTURE structure OF coe328lab2 IS
...
-- Equation(s):
-- \f~0_combout\ = (\x3~combout\ & (!\x4~combout\ & ((\x1~combout\) # (!\x2~combout\)))) # (!\x3~combout\ & (\x4~combout\ $ (((\x1~combout\ & !\x2~combout\)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0100101001010110",
